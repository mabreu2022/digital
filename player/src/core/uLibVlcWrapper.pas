...
type
  ...
  Tlibvlc_event_t = record
    ...
    p_obj: Pointer;
    // Dados adicionais do evento podem vir aqui
  end;
...
begin
  ...
  try
    ...
    ArgsList.Add('--avcodec-hw=any');       // Habilitar aceleração por hardware (VAAPI/VDPAU/D3D11)
